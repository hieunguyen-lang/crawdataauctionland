...
class LandAuctions(Base):
    ...
    AuctionAddress = Column(String(500), unique=True, nullable=True)
    Latitude = Column(Float, nullable=True)
    Longitude = Column(Float, nullable=True)
    CreateAt = Column(DateTime, nullable = True)
    AuctionUrl = Column(String(1000), unique=True, nullable=True)
    NamePropertyOwner = Column(String(500), nullable=True)
    NameProperty = Column(String(500), nullable=True)
    AddressProperty = Column(String(500), nullable=True)
    AddressPropertyOwner = Column(String(500), nullable=True)
    NameAuctionHouse = Column(String(500), nullable=True)
    AddressAuctionHouse = Column(String(500), nullable=True)
